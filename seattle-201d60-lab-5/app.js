...
if (sumValues[0]== 11 && sumSentence === 'The sum fo 4 and 7 is 11') {

} else {
  console.log('%c TEST FOR sum ( FAILS', 'color: green')
}
...
function multiply(a, b) { //eslint-disable-line
  var product = a*b;
  var newSent= [product, `the product of' ${a} and ${b} is ${product}.`];
